...
##################################################################
#
# Processing Script for Alcohol Induced Deaths
...
all_geogs$Variable <- "Alcohol Induced Deaths"
...
write.table(
  all_geogs_fips,
  file.path(getwd(), "data", "alcohol-induced-deaths_2010-2014.csv"),
  sep = ",",
  na = "-6666",
  row.names = F
)
